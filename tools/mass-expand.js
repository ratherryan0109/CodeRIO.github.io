...
// All extra concepts by courseId
var extras = {
  'python': {
...
// Process courses in REVERSE order so earlier positions stay valid
var courseIds = Object.keys(extras);
courseIds.sort().reverse();  // process from last file position to first
